            ...
            <div class="container">
                <div class="tf-shop-control grid-3 align-items-center">
                    ...
                    <ul class="tf-control-layout d-flex justify-content-center">
                        ...
                        <li class="tf-view-layout-switch sw-layout-6 active" data-value-grid="grid-6">
                    ...
                    <div id="product-name" class="collapse show">
                        <form action="" method="get">
                            <div class="d-flex mb-5">
                                <input type="hidden" name="act" id="shop">
                        ...
                        <div id="availability" class="collapse show">
                            <ul class="tf-filter-group current-scrollbar mb_36">
                                <li class="list-item d-flex gap-12 align-items-center">
                                    ...
                                    ?>
                                    class="label">
                                    <span>In stock</span>&nbsp;<span>(<?= $stock[0]->instock?>)</span></label>
                                    </a>
                                ...
                                <li class="list-item d-flex gap-12 align-items-center">
                                    ...
                                    ?>
                                    class="label">
                                    <span>Out of stock</span>&nbsp;<span>(<?= $stock[1]->outstock?>)</span></label>
                                    </a>
                    ...
                    <div class="widget-facet">
                        ...
                        <div id="price" class="collapse show">
                            ...
                            <div class="widget-price filter-price">
                                ...
                                <button class="btn btn-primary mt-2 btn-sm">Search</button>
                                </div>
