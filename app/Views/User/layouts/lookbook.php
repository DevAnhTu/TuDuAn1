                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-lookbook lookbook-1">
                            <div class="image">
                                <img class="lazyload" data-src="assets/User/images/shop/file/lookbook-3.jpg" src="assets/User/images/shop/file/lookbook-3.jpg" alt="image-lookbook">
                            </div>
                                            ...
                                            <li>
                                                <div class="lookbook-product">
                                                    <a href="product-detail.html" class="image">
                                                        <img class="lazyload" data-src="assets/User/images/shop/products/img-p2.png" src="assets/User/images/shop/products/img-p2.png" alt="lookbook-item">
                                                    </a>
                                    ...
                                    <div class="btn-group dropdown dropup dropdown-center">
                                        ...
                                        <ul class="dropdown-menu p-0 border-0">
                                            <li>
                                                <div class="lookbook-product">
                                                    <a href="product-detail.html" class="image">
                                                        <img class="lazyload" data-src="assets/User/images/shop/products/img-p4.png" src="assets/User/images/shop/products/img-p4.png" alt="">
                                                    </a>
                                                    <div class="content-wrap">
                                                        <div class="product-title">
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-lookbook lookbook-2">
                            <div class="image">
                                <img class="lazyload" data-src="assets/User/images/shop/file/lookbook-4.jpg" src="assets/User/images/shop/file/lookbook-4.jpg" alt="image-lookbook">
                            </div>
                            <div class="lookbook-item item-1">
                                <div class="inner">
                                    <div class="btn-group dropdown dropup dropdown-center">
                                        ...
                                        <ul class="dropdown-menu p-0 border-0">
                                            <li>
                                                <div class="lookbook-product">
                                                    <a href="product-detail.html" class="image">
                                                        <img class="lazyload" data-src="assets/User/images/shop/products/img-p5.png" src="assets/User/images/shop/products/img-p5.png" alt="">
                                                    </a>
                                                    <div class="content-wrap">
                                                        <div class="product-title">
