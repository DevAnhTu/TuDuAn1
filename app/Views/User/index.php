...
<body class="preload-wrapper popup-loader">
    ...
    <div id="wrapper">
        <!-- Top Bar -->
            <?php include 'app/Views/User/layouts/contact.php'?>
        <!-- /Top Bar -->
        <!-- Header -->
        ...
        <!-- /Header -->
        <!-- Slider -->
        <?php include 'app/Views/User/layouts/slideshow.php'?>
        
        <!-- /Slider -->
        <!-- Marquee -->
        <?php include 'app/Views/User/layouts/marquee.php'?>
                                    ...
                                    <div class="collection-item style-left hover-img">
                                        <div class="collection-inner">
                                            <a href="<?= BASE_URL?>?act=shop&category_id=<?=$value->id?>" class="collection-image img-style">
                                                <img class="lazyload" data-src="assets/User/images/collections/collection-17.jpg" src="assets/User/images/collections/collection-17.jpg" alt="collection-img">
                                            </a>
        ...
        <!-- /Seller -->
        <!-- Lookbook -->
        <?php include 'app/Views/User/layouts/lookbook.php'?>
        
        <!-- /Lookbook -->
        <!-- Testimonial -->
        <?php include 'app/Views/User/layouts/testimonial.php'?>
        <!-- /Testimonial -->
        <!-- brand -->
        <?php include 'app/Views/User/layouts/brand.php'?>
        
        <!-- /brand -->
        <!-- Shop Gram -->
        <?php include 'app/Views/User/layouts/shopgram.php'?>
        
        <!-- /Shop Gram -->
        <!-- Icon box -->
        <?php include 'app/Views/User/layouts/iconbox.php'?>
                            ...
                            <div class="tf-mini-cart-sroll">
                                <div class="tf-mini-cart-items">
                                    <div class="tf-mini-cart-item">
                                        <div class="tf-mini-cart-image">
                                            <a href="product-detail.html">
                                                <img src="assets/User/images/products/white-2.jpg" alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div class="tf-mini-cart-item">
                                        <div class="tf-mini-cart-image">
                                            <a href="product-detail.html">
                                                <img src="assets/User/images/products/white-3.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="tf-mini-cart-info">
