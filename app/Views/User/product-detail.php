...
<body class="preload-wrapper popup-loader">
                        ...
                        <div class="col-md-6">
                            <div class="tf-product-info-wrap sticky-top">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <!-- <div class="tf-product-info-countdown">
                                        <div class="countdown-wrap">
                                            ...
                                            <div class="tf-countdown style-1">
                                                <div class="js-countdown" data-timer="1007500" data-labels="Days :,Hours :,Mins :,Secs"><div aria-hidden="true" class="countdown__timer"><span class="countdown__item"><span class="countdown__value countdown__value--0 js-countdown__value--0">11</span><span class="countdown__label">Days :</span></span><span class="countdown__item"><span class="countdown__value countdown__value--1 js-countdown__value--1">15</span><span class="countdown__label">Hours :</span></span><span class="countdown__item"><span class="countdown__value countdown__value--2 js-countdown__value--2">51</span><span class="countdown__label">Mins :</span></span><span class="countdown__item"><span class="countdown__value countdown__value--3 js-countdown__value--3">17</span><span class="countdown__label">Secs</span></span></div></div>
                                            </div>
                                        </div>
                                    </div> -->
                                    ...
                                    <div class="tf-product-info-quantity mb-5">
                                        ...
                                        <form class="">
                                            <a href="javascript:void(0);"
                                             ...
                                             <span class="tf-qty-price total-price">
                                                <?= $product->price_sale != null ? number_format($product->price_sale) :
                                    ...
                                    <div class="tf-pickup-availability mb-5">
                                        <div>
                    ...
                    <div class="tf-height-observer w-100 d-flex align-items-center">
                        <div class="tf-sticky-atc-product d-flex align-items-center">
                            <div class="tf-sticky-atc-img">
                                ...
                                data-src="<?= $product->image_main?>" alt=""
                            ...
                            <div class="widget-content-tab">
                                ...
                                <div class="widget-content-inner">
                                    <div class="tab-reviews write-cancel-review-wrap">
                                            ...
                                            <div class="reply-comment-wrap">
                                                ...
                                                <div class="reply-comment-item">
                                                    <div class="user">
                                                        ...
                                                        <div>
                                                            <h6>
                                                                <a href="#" class="lintiok"><?= $value->name?></a>
                                                            </h6>
                                        ...
                                        <form action="<?= BASE_URL?>?act=write-review" method="post" class="form-write-review write-review-wrap">
                                            <div class="heading">
        ...
        <section class="flat-spacing-5 pt_0 flat-seller">
            <div class="container">
                <div class="flat-title">
                    ...
                    data-wow-delay="0s"
                     style="visibility: visible; animation-delay: 0s; animation-name: fadeInUp;">Các sản phẩm liên quan</span>
                </div>
                <div class="grid-layout loadmore-item wow fadeInUp" 
                data-wow-delay="0s" data-grid="grid-4" 
                ...
                <!-- card product 1 -->
                    <div class="card-product fl-item" style="display: block;">
                        <div class="card-product-wrapper">
                            ...
                            <img class="img-product" src="<?= $value->image_main?>" data-src="<?= $value->image_main?>" alt="">    
                            <img class="img-product ls-is-cached lazyloaded" 
                                data-src="<?= $value->image_main?>"
                        ...
                        <div class="card-product-info">
                            <a href="http://localhost/duanmvc/?act=product-detail&amp;product_id=17" 
                            class="title link"><?=$value->name?></a>
                            <div style="display: flex">
                            
                            <span class="price" style="text-decoration: line-through;">
                            <?php if($value->price_sale != null):?>
                                <span class="price" style="text-decoration: line-through;"><?= number_format( $value->price)?>VNĐ</span>
                            <span class="price price_sale"><?= number_format($value->price_sale)?>VNĐ</span>
                            <?php else:?>
    ...
    document.querySelector(".btn-decrease-custom").addEventListener("click", function () {
        let quantityInput = document.querySelector(".quantity-product");
        ...
        if (quantity > 1) {
            ...
            // Tính toán tổng giá và cập nhật
            let total = price * quantity;
            document.querySelector(".total-price").textContent = total.toFixed()+" "+"VNĐ"; // Định dạng 2 chữ số thập phân
        }
    });
    ...
    document.querySelector(".btn-increase-custom").addEventListener("click", function () {
        ...
        // Tăng số lượng và cập nhật input
        quantity += 1;
        quantityInput.value = quantity;
