                    ...
                    <div class="main-content">
                        ...
                        <div class="main-content-inner">
                           ...
                           <?php if (isset($_SESSION['message'])) {
                            ...
                            ?>
                                    <div class="title-box">
                                        <h4>Chỉnh sửa Users</h4>
                                    
                                    </div>
                                    <form action="<?= BASE_URL?>?role=admin&act=update-post-user&id=<?= $_GET['id']?>" method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
                                        <label for="">Name</label>
                                        <input type="text" id="name" placeholder="Name" name="name" class="from-control" value="<?= $user->name?>">
                                        </div>
                                        <div class="mb-3">
                                        <label for="email">Email</label>
                                        <input type="email" id="email" placeholder="email" name="email" class="from-control"<?= $user->email?>>
                                        </div>
                                        
                                        <div class="mb-3">
                                        <label for="password">Password</label>
                                        <input type="password" id="password" placeholder="Password" name="password" class="from-control">
                                        </div>
                                        <div class="mb-3">
                                        <label for="address">Address</label>
                                        <input type="text" id="address" placeholder="address" name="address" class="from-control"<?= $user->address?>>
                                        </div>
                                        <div class="mb-3">
                                        <label for="phone">Phone</label>
                                        <input type="text" id="phone" placeholder="phone" name="phone" class="from-control"<?= $user->phone?>>
                                        </div>
                                        <div class="mb-3">
                                        <label for="image">Image</label>
                                        <img src="<?= $user->image?>" alt="" width="50">
                                        <input type="file" id="image"  name="image" accept="image/*" class="from-control">
                                        </div>
                                        <div class="mb-3">
