                    ...
                    <div class="main-content">
                        ...
                        <div class="main-content-inner">
                           ...
                           <?php if (isset($_SESSION['message'])) {
                            ...
                            ?>
                                    <div class="title-box">
                                        <h4>Thêm mới Users</h4>
                                    
                                    </div>
                                    <form action="<?php BASE_URL?>?role=admin&act=post-add-user" method="post" enctype="multipart/form-data">
                                        <div class="mb-3">
                                        ...
                                        <input type="email" id="email" placeholder="email" name="email" class="from-control">
                                        </div>
                                        ...
                                        <input type="text" id="address" placeholder="address" name="address" class="from-control">
                                        </div>
                                        <div class="mb-3">
                                        <label for="phone">Phone</label>
                                        <input type="text" id="phone" placeholder="phone" name="phone" class="from-control">
                                        </div>
                                        <div class="mb-3">
