                            ...
                            ?>
                                    ...
                                    <form action="<?= BASE_URL?>?role=admin&act=update-post-product&id=<?=$_GET['id'] ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="text" id="name" placeholder="Name"
                                         name="name" class="from-control" value="<?= $product->name?>">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        class="from-control" value="<?= $product->price?>">
                                        </div>
                                        <div class="mb-3">
                                        <label for="price-sale">Price_sale</label>
                                        <input type="text" id="price-sale" placeholder="price-sale" 
                                        name="pricesale" class="from-control" value="<?= $product->price_sale?>">
                                        </div>
                                        <div class="mb-3">
                                        <label for="stock">Stock</label>
                                        <input type="text" id="stock" placeholder="stock" 
                                        name="stock" class="from-control" value="<?= $product->stock?>">
                                        </div>
                                        <div class="mb-3">
                                        <label for="image_main">Image main</label>
                                        <img src="<?= $product->image_main?>" alt="" width="50">
                                        <input type="file" id="image_main" placeholder="image_main" name="image_main" class="from-control" accept="image/*">
                                        </div>
                                        <div class="mb-3">
                                        <label for="description">Description</label>
                                        <textarea id="description" placeholder="description" 
                                        name="description" class="from-control" value="<?= $product->description?>"></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <h4>List image</h4>
                                            <button class="btn-sm btn btn-warning" id="btnAddImage">Add Image</button>
                                            <hr>  
    ...
    <script>
         ...
         <?php if(count($listProductImage) > 0) : ?>
            ...
            <div class="mb-4 mb-4">
                ...
                <div class="d-flex">
                    <input type="file" class="ferom-control" name="image[]" accept="image/*">
