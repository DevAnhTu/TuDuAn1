                           ...
                           <?php if (isset($_SESSION['message'])) {
                            ...
                            ?>
                                    ...
                                    <form action="<?= BASE_URL?>?role=admin&act=add-post-product" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="text" id="price" placeholder="price" name="price" class="from-control">
                                        </div>
                                        <div class="mb-3">
                                        <label for="price-sale">Price_sale</label>
                                        <input type="text" id="price-sale" placeholder="price-sale" name="pricesale" class="from-control">
                                        </div>
                                        <div class="mb-3">
                                        <label for="stock">Stock</label>
                                        <input type="text" id="stock" placeholder="stock" name="stock" class="from-control">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <textarea id="description" placeholder="description" name="description" class="from-control"></textarea>
                                        </div>
                                        <div class="mb-3">
                                         <h4>List image</h4>
